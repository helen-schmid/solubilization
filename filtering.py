...
from utils.af3_utils import build_af3_json, run_af3_singularity, parse_af3_summary
...
parser.add_argument("--ligand_smiles", type=str, help="SMILES string of the native ligand to cofold each design with")
...
def main(args):
    ...
    columns = ['ID', 'sequence', 'af3_iptm', 'af3_ptm', 'af3_ranking_score', 'af3_chain_pair_pae_min', 'af3_fraction_disordered', 'af3_has_clash']
    ...
    for row in rows:
        ...
        #collecting the scores from the cofold
        summary_path = os.path.join(design_out_dir, design_id, f'{design_id}_summary_confidences.json')
