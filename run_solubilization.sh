...
python /work/lpdi/users/hilditch/scripts/repos/solubilization/solubilization.py \
        -working_dir /work/lpdi/users/hilditch/scripts/repos/solubilization/test \
        -input_pdb /work/lpdi/users/hilditch/scripts/repos/solubilization/1jgj.pdb \
        -num_backbones 3\
